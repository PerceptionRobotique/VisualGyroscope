...
/*!
 \class prGaussianMixtureSample prGaussianMixtureSample.h <per/prGaussianMixtureSample.h>
 \brief Class defining a gaussian mixture sample from a general intensity
 */
template<typename Ts>
class prGaussianMixtureSample : public prIntensity
{
public:
    /*!
