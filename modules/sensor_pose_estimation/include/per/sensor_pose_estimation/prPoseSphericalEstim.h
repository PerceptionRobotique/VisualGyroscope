...
/*!
 \class prPoseSphericalEstim prPoseSphericalEstim.h <per/prPoseSphericalEstim.h>
 \brief Class implementing pose estimation algorithms for spherical cameras
 */
template<typename FSetT, typename FSetCmpT>
class prPoseSphericalEstim : public prCameraPoseEstim {
...
public:
     ...
     */
    prPoseSphericalEstim() : nb_s(0), iterMax(40), nbIncrMax(5), seuilResidu(1e-9) //1e-6 en gyro pur ; 1e-9 en odometrie
    {
        setdof();
    }
