...
//        return -6;
    ...
    */
    ...
    prPoseSphericalEstim<prFeaturesSet<prCartesian3DPointVec, prPhotometricGMS<prCartesian3DPointVec>, IMAGEREPRESENTATION >, prSSDCmp<prCartesian3DPointVec, prPhotometricGMS<prCartesian3DPointVec> > > gyro(1e-6);
...
//        }
        ...
        if(stabilisation)
        {
            ...
            #if defined(IMGREP) && IMGREP == 1
                prStereoModel dummyStereoCam(2);
                std::cout << "toImageRotate: " << IS_des.toTwinOmni(I_r, ir, dummyStereoCam) << std::endl;
            #else
        ...
        else
        {
            ...
            #if defined(IMGREP) && IMGREP == 1
                prStereoModel dummyStereoCam(2);
                std::cout << "toImageRotate: " << IS_req.toTwinOmni(I_r, r, dummyStereoCam) << std::endl;
            #else
